...
internal class AutofacTheoryDiscoverer : TheoryDiscoverer
{
    ...
    protected override IEnumerable<IXunitTestCase> CreateTestCasesForSkip(ITestFrameworkDiscoveryOptions discoveryOptions,
                                                                          ...
                                                                          string skipReason)
    {
        return new[] { new AutofacTestCase(DiagnosticMessageSink, discoveryOptions.MethodDisplayOrDefault(), testMethod) };
    }
                                                                                    ...
                                                                                    string skipReason)
    {
        return new[]
               {
                   new AutofacSkippedDataRowTestCase(DiagnosticMessageSink, discoveryOptions.MethodDisplayOrDefault(), testMethod, skipReason,
                                                     dataRow)
               };
    }
}
